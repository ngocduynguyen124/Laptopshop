                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://hoidanit.vn" target="_blank">
                                ...
                                <p class="text-secondary mb-0">ngocduy20243@gmail.com</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p> <a href="https://www.facebook.com/duy.ngoc.543908" target="_blank"> FB : Ngọc Duy</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://www.facebook.com/duy.ngoc.543908" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Nguyễn Ngọc Duy</a>, All right
                            reserved.</span>
                    </div>
