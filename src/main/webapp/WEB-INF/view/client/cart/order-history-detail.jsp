...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5" style="margin-top: 20px;">
            ...
            <p>Ngày Đặt Mua : <fmt:formatDate value="${order.date}" pattern="dd/MM/yyyy HH:mm:ss" /> </p>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="orderDetail" items="${order.orderDetails}">
                            <tr>
                                <td>
                                    <img src="/images/product/${orderDetail.product.image}" class="product-image rounded-circle" alt="">
                                </td>
