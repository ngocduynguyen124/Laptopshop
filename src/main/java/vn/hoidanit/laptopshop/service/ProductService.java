...
public class ProductService {
    ...
    // Phương thức để tạo số đơn hàng ngẫu nhiên
    private String generateOrderNumber() {
        Random random = new Random();
        int randomNumber = random.nextInt(1000000); // Điều chỉnh phạm vi số ngẫu nhiên tùy ý
        return "ORD" + String.format("%06d", randomNumber); // Định dạng "ORD" theo sau bởi 6 chữ số
    }
}
